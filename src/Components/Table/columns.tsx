...
import { QUERY_KEYS, QUERY_KEYS_COURSE, QUERY_KEYS_DEPARTMENT, QUERY_KEYS_ENTITY, QUERY_KEYS_FORM, QUERY_KEYS_HOBBY, QUERY_KEYS_LANGUAGE, QUERY_KEYS_MENU, QUERY_KEYS_ROLE, QUERY_KEYS_ROLEVSADMIN, QUERY_KEYS_ROLEVSFORM, QUERY_KEYS_STUDENT, QUERY_KEYS_SUBJECT, QUERY_KEYS_SUBMENU } from "../../utils/const";
    ...
    }, 
    {
      ...
      Cell: ({ cell,row }) => {
        ...
        const active = (id: number,valueset:any)=>{
          ...
          putData(`${valueset === 1 ? MenuInstituteDeactive : MenuInstituteActive}/${id}`).then((data: any) => {
        ...
        // const columns: any[] = [
          ...
          },
          {
            ...
            Cell: ({ cell,row }) => {
              ...
              const active = (id: number,valueset:any)=>{
                putData(`${valueset === 1 ? MenuEntityDeactive : MenuEntityActive}/${id}`).then((data: any) => {
              ...
              }, 
              {
                ...
                Cell: ({ cell,row }) => {
                  ...
                  const active = (id: number,valueset:any)=>{
                    ...
                    putData(`${valueset === 1 ? MenuDeactive : MenuActive}/${id}`).then((data: any) => {
              ...
              // },
                {
                  ...
                  Cell: ({ cell }) => {
                      ...
                      return (
                          ...
                          <img src={value!=="" ? value :profile} alt='profile' height="50px" width="50px"/>
                      </div>
                      )
                    },
              },
        ...
        },
         {
           ...
           size: 150,
              Cell: ({ cell }) => {
                ...
                const camelCaseValue = value?.replace(/\b(\w)/g, (match: string) => match?.toUpperCase());
                return (
                  <div>
                    {camelCaseValue}
                  </div>
            ...
            },
            {
              ...
              Cell: ({ cell,row }) => {
                ...
                const active = (id: number,valueset:any)=>{
                  ...
                  putData(`${valueset === 1 ? StudentDeactive : StudentActive}/${id}`).then((data: any) => {
...

{
  ...
  Cell: ({ cell }: any) => {
      ...
      flattenedAnswers = flattenedAnswers?.map((item: any) => {
      ...
      return (
          <div>
              {formattedMessage || "No answer available"}
          </div>
      );
  },
},
